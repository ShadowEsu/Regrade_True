...
| --- | --- | --- |
| Authentication | `src/AuthGate.tsx`, `src/views/Auth.tsx`, `src/lib/firebase.ts`, `src/lib/nativeAuth.ts` | Functional with Firebase configuration; missing configuration fails closed |
