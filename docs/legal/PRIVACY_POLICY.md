...
> **Draft for review:** This document must be reviewed by a qualified privacy
> professional before public beta or production use. It is not legal advice.
...
Regrade is designed to support students age **8 and older**. Younger
students should use Regrade with a parent, guardian, teacher, or other
school-authorized adult. Where applicable law requires parental consent,
school authorization, or another lawful basis before a child can use the
Service, that authorization must be obtained before the child account is
activated or personal information is collected. Adults and schools must
only link learners they are authorized to supervise. If we learn that a
child's information was collected without the authorization required by
applicable law, we will restrict or delete it as required.

> **Legal review required before release:** the consent, age-assurance,
> school-authorization, deletion, and regional child-privacy procedures
> described here must be reviewed and operationally validated by qualified
> counsel/privacy professionals. Product wording of “8+” is not itself a
> determination that child access is legally permitted in every region.
