...
- Complete age rating and child-directed audience questions with qualified legal/privacy review. Product messaging says 8+, with adult guidance recommended for younger students; store category and consent obligations remain unapproved.
...
- Complete content rating, target audience, Families-policy review, app access/reviewer credentials, ads declaration (none), and privacy policy.
