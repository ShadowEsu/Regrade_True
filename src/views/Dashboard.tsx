...
export default function Dashboard({
  ...
  return (
    <div className="space-y-32 max-w-7xl mx-auto py-12">
      <section className="relative text-left">
        <div className="max-w-4xl mb-20 space-y-10">
          <div className="flex items-center gap-6">
            ...
            <span className="text-[12px] sm:text-sm font-medium tracking-[0.45em] text-primary opacity-45 uppercase">
              Your Dashboard
            </span>
          </div>
          ...
          <motion.h1
            ...
            className="text-5xl md:text-7xl lg:text-8xl text-primary font-semibold leading-[1.08] tracking-tight -ml-1"
          >
            Welcome, <span className="font-semibold text-primary/70">{firstName}</span>.
          </motion.h1>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start gap-8 text-on-surface-variant font-medium text-xl md:text-2xl opacity-80">
            <div className="flex items-center gap-4 bg-green-500/10 px-4 py-2 rounded-full border border-green-500/20">
              ...
              <span className="text-[11px] font-semibold uppercase tracking-widest text-green-700">Signed In</span>
            </div>
            <p className="leading-relaxed max-w-xl text-primary/70">
        ...
        >
          ...
          <div className="flex items-center gap-10 relative z-10 text-left">
            ...
            <div className="space-y-3">
              <h2 className="text-4xl md:text-5xl font-semibold tracking-tight leading-tight text-white">Start New Appeal</h2>
              <p className="text-white/60 italic text-lg md:text-xl max-w-lg leading-relaxed">Upload your graded assignment and let Regrade analyze your case.</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-6 relative z-10 bg-white text-primary px-10 py-5 rounded-full group-hover:bg-white/90 transition-all shadow-xl hover:scale-105">
            <span className="font-semibold uppercase tracking-[0.28em] text-xs">Get started</span>
          ...
          <div className="md:w-3/5 p-12 flex flex-col justify-between space-y-8">
            <div className="space-y-6">
              <div className="flex justify-between items-center">
                <span className="text-[11px] font-semibold uppercase tracking-[0.22em] text-[#006c49] bg-green-500/10 px-4 py-1.5 rounded-full border border-green-500/20">
              ...
              <h3 className="text-4xl text-primary font-semibold leading-tight tracking-tight">
                {latestCase ? latestCase.title : 'No active appeal'}
              </h3>
              <p className="text-lg text-primary/60 italic leading-relaxed">
            ...
            <div className="space-y-6 pt-8 border-t border-primary/5">
              <div className="flex items-center justify-between text-[11px] font-semibold uppercase tracking-[0.28em] text-primary/50">
                ...
                {['Evidence', 'Analyzed', 'Submitted'].map((label, idx) => {
                  ...
                  return (
                    <div key={label} className="flex-1 space-y-2">
                      ...
                      <p
                        className={`text-[10px] font-semibold uppercase tracking-widest ${isActive ? 'text-primary' : 'text-primary/30'}`}
                      >
                        {label}
                      </p>
                    </div>
      ...
      {onOpenSampleVerdict && latestCase && (
        <section className="max-w-2xl">
          <button
            type="button"
            onClick={onOpenSampleVerdict}
            className="w-full glass-panel p-6 rounded-2xl border border-amber-200/60 bg-amber-50/50 text-left hover:bg-amber-50 transition-colors"
          >
            <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-amber-800/70 block mb-2">
              Preview
            </span>
            <span className="text-xl text-primary">View sample analysis report</span>
            <p className="text-sm text-primary/60 mt-2 font-medium">
              Opens the full verdict screen with demo Gradescope data — no upload required.
            </p>
          </button>
        </section>
      )}
        ...
        >
          <div className="flex items-center justify-between mb-4 text-primary group-hover:text-primary transition-colors">
            <span className="flex items-center gap-2">
              ...
              <span className="text-[10px] font-semibold uppercase tracking-[0.35em] text-secondary">Live</span>
            </span>
            <ICONS.ArrowRight size={20} className="opacity-60 group-hover:opacity-100 group-hover:translate-x-2 transition-all" />
          </div>
          <h4 className="text-2xl md:text-[1.65rem] text-primary font-medium mb-2">Appeal assistant chat</h4>
          <p className="text-[13px] sm:text-sm text-on-surface-variant/70 font-medium leading-relaxed tracking-tight">
