      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-24">
        ...
        <div className="lg:col-span-8 flex flex-col items-center">
          ...
          >
            ...
            <footer className="mt-16 pt-8 border-t border-primary/5 flex justify-between items-center opacity-50 relative z-10">
              <div className="flex items-center gap-2">
                <img src="/logo-wordmark.png" alt="Regrade" height={22} className="w-auto object-contain opacity-80" style={{ height: 22 }} />
